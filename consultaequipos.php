...
$sentenciaSQL="SELECT codigo,idproducto,equipo,modelo,fechainsta,procesador,memoria,discoduro,teclado,raton,titular,area,activo,monitor,nsmonitor,observaciones FROM equipos;";
...
{
echo "<tr><td>".$registro[0]."</td><td>".$registro[1]."</td><td>".$registro[2]."</td><td>".$registro[3]."</td><td>".$registro[4]."</td><td>".$registro[5]."</td><td>".$registro[6]."</td><td>".$registro[7]."</td><td>".$registro[8]."</td><td>".$registro[9]."</td><td>".$registro[10]."</td><td>".$registro[11]."</td><td>".$registro[12]."</td><td>".$registro[13]."</td><td>".$registro[14]."</td><td>".$registro[15]."</td></tr>";
}
?>
</body>
</html>