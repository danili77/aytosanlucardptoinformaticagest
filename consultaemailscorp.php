<html>
<head>
<title>Consultar base datos "dptoinformática" Tabla emailscorp</title>
</head>
<body bgcolor="beige">
...
$sentenciaSQL="SELECT idcuenta,direccioncorreo,cuenta,password,area,titular,fechacreacion,cargo,observaciones FROM emailscorp WHERE titular='$_GET[titular]';";
...
<td><b><center>FECHA CREACIÓN</center></b></td>
...
<tr><td><center><a href="formbusqueda1.html">Atrás</a></center></td></tr>
</table> 
</body>
</html>